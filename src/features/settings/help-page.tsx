    ...
    <PageLayout title={i18n.t("help.title")} description={i18n.t("help.description")}>
      <div className="flex flex-col gap-6">
        ...
        <ConfigCard title={i18n.t("help.contact.title")} description={i18n.t("help.contact.desc")}>
          <div className="grid gap-3 md:grid-cols-2">
            <ConfigCard title={i18n.t("popup.more.project")}>
              <span className="text-sm text-muted-foreground">{i18n.t("help.contact.githubDesc")}</span>
            </ConfigCard>
            <ConfigCard title={i18n.t("popup.more.feedback")}>
              <span className="text-sm text-muted-foreground">{i18n.t("help.contact.emailDesc")}</span>
            </ConfigCard>
          </div>
        </ConfigCard>
      </div>
