...
function createOverlay(message: string, withCancel: boolean) {
  ...
  panel.style.color = "var(--card-foreground)"
  ...
  confirmButton.style.border = "1px solid var(--primary)"
  confirmButton.style.borderRadius = "6px"
  confirmButton.style.background = "var(--primary)"
  confirmButton.style.color = "var(--primary-foreground)"
  ...
  if (withCancel) {
    ...
    cancelButton.style.background = "var(--background)"
    cancelButton.style.color = "var(--foreground)"
